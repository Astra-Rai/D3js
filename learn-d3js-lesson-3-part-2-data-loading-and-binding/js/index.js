...
d3.select('body')
  ...
  .append('p')
    ...
    //add text below to paragraph tags, this is commented out to run funciton below
    //.text('D3 is awesome!!');
  ...
  */
  ...
  //paragraph will display the value of data item inside of it
  //write a function withinin .text method, function to return the data item inside the dataset  
  .text(function(d) {
      return d; 
    });

//you can write this on one line
//note proper syntax of function within method